...
An AI-powered customer support chatbot for Apex Stride that adapts its tone and responses based on context. All brand settings, tone rules, and product 
config live in "brand_config.yaml".
